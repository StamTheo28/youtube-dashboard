...
class Video_id_Tests(TestCase):
    def test_valid_urls(self):
        valid_url_list = [ "http://www.youtube.com/watch?v=0zM3nApSvMg&feature=feedrec_grec_index",
        ...
        self.assertTrue(url_to_videoId_parser(valid_url_list[0])=="0zM3nApSvMg")
        self.assertTrue(url_to_videoId_parser(valid_url_list[1])=="0zM3nApSvMg")
        self.assertTrue(url_to_videoId_parser(valid_url_list[2])=="0zM3nApSvMg")
        self.assertTrue(url_to_videoId_parser(valid_url_list[3])=="0zM3nApSvMg")
        self.assertTrue(url_to_videoId_parser(valid_url_list[4])=="0zM3nApSvMg")
        self.assertTrue(url_to_videoId_parser(valid_url_list[5])=="0zM3nApSvMg")
        self.assertTrue(url_to_videoId_parser(valid_url_list[6])=="0zM3nApSvMg")

    # Test invalid urls of youtube videos
    def test_invalid_urls(self):
        invalid_url_list = [ "http://www.youtube/watch?v=nApSvMg&feature=feedrec_grec_index",
        ...
        self.assertFalse(url_to_videoId_parser(invalid_url_list[0])=="0zM3nApSvMg")
        self.assertFalse(url_to_videoId_parser(invalid_url_list[1])=="0zM3nApSvMg")
        self.assertFalse(url_to_videoId_parser(invalid_url_list[2])=="0zM3nApSvMg")
        self.assertFalse(url_to_videoId_parser(invalid_url_list[3])=="0zM3nApSvMg")
        self.assertFalse(url_to_videoId_parser(invalid_url_list[4])=="0zM3nApSvMg")
        self.assertFalse(url_to_videoId_parser(invalid_url_list[5])=="0zM3nApSvMg")
        self.assertFalse(url_to_videoId_parser(invalid_url_list[6])=="0zM3nApSvMg")
        self.assertFalse(url_to_videoId_parser(invalid_url_list[7])=="0zM3nApSvMg")
...
class ViewTests(TestCase):
    ...
    def test_valid_url_dashboard_view(self):
        video_id = url_to_videoId_parser('http://www.youtube.com/embed/0zM3nApSvMg?rel=0')
    ...
    def test_valid_url_dashboard_view(self):
        video_id = url_to_videoId_parser('http://www.youtube.co.uk/watchs?v=0zM3nApSvMgs')
        response = self.client.get(reverse('analysis',args=[video_id]))  
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'html/index.html')  

    # Test analysis View with valid video_id
    def test_valid_video_id_dashboard_view(self):
        response = self.client.get(reverse('analysis',args=['0zM3nApSvMg']))  
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'html/dashboard.html')  
